  ...
  return (
    <div className="subpage">
      ...
      <section className="dept-page__hero" style={{ '--dept-hue': dept.hue }}>
        <div className="dept-page__hero-bg" style={{ backgroundImage: `url(/images/${deptSlug}.png)` }}></div>
        ...
        <div className="container dept-page__hero-content">
          ...
          {deptSlug === 'mechanical' && (
            <div className="dept-page__hero-actions" data-animate="fade-up" data-delay="400" style={{ marginTop: '24px' }}>
              <Link href="/mechanical-faculty" className="btn btn--primary" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.3)' }}>
                <Users size={18} />
          ...
          {deptSlug === 'wood' && (
            <div className="dept-page__hero-actions" data-animate="fade-up" data-delay="400" style={{ marginTop: '24px' }}>
              <Link href="/wood-faculty" className="btn btn--primary" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.3)' }}>
                <Users size={18} />
                View Faculty Details
              </Link>
            </div>
          ...
          {deptSlug === 'textile' && (
            <div className="dept-page__hero-actions" data-animate="fade-up" data-delay="400" style={{ marginTop: '24px' }}>
              <Link href="/textile-faculty" className="btn btn--primary" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.3)' }}>
                <Users size={18} />
                View Faculty Details
              </Link>
            </div>
          ...
          {deptSlug === 'electronics' && (
            <div className="dept-page__hero-actions" data-animate="fade-up" data-delay="400" style={{ marginTop: '24px' }}>
              <Link href="/electronics-faculty" className="btn btn--primary" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.3)' }}>
                <Users size={18} />
                View Faculty Details
              </Link>
            </div>
          ...
          {deptSlug === 'civil' && (
            <div className="dept-page__hero-actions" data-animate="fade-up" data-delay="400" style={{ marginTop: '24px' }}>
              <Link href="/civil-faculty" className="btn btn--primary" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.3)' }}>
                <Users size={18} />
                View Faculty Details
              </Link>
            </div>
          ...
          {deptSlug === 'electrical' && (
            <div className="dept-page__hero-actions" data-animate="fade-up" data-delay="400" style={{ marginTop: '24px' }}>
              <Link href="/electrical-faculty" className="btn btn--primary" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.3)' }}>
                <Users size={18} />
                View Faculty Details
              </Link>
            </div>
